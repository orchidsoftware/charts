...
{
    /**
     * Create a new theme styles builder instance.
     */
    public function __construct(private Theme $lightTheme, private ?Theme $darkTheme = null) {}

    /**
     * Append theme CSS rules to the CSS builder.
     */
    ...
    /**
     * Build CSS custom properties for the given theme.
     */
    ...
    /**
     * Get CSS selector rules for chart styling.
     *
