...
final class AxisLayoutAndGridTest extends TestCase
{
    public function test_axis_padding_calculator_returns_expected_plot_area(): void
    {
    ...
    public function test_axis_ticks_and_horizontal_grid_lines_are_derived_from_scale(): void
    {
