...
final class CustomizationIntegrationTest extends TestCase
{
    public function test_chart_renders_with_custom_theme_contract_implementation(): void
    {
        $svg = LineChart::make()
            ->labels(['A'])
            ->dataset('One', [1])
    ...
    public function test_chart_uses_injected_custom_renderer_instance(): void
    {
