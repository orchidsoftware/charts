...
final class CoreDomainBehaviorTest extends TestCase
{
    public function test_chart_data_values_flattens_all_dataset_values(): void
    {
        $data = new ChartData(
            labels: ['A', 'B'],
            datasets: [
    ...
    public function test_chart_data_ensure_datasets_throws_when_empty(): void
    {
    ...
    public function test_plot_area_right_and_bottom_edges_are_computed_from_size(): void
    {
    ...
    public function test_linear_scale_expands_expected_ranges(array $values, float $expectedMin, float $expectedMax): void
    {
    ...
    public function test_linear_scale_maps_extreme_values_to_plot_bounds(): void
    {
        $area = new PlotArea(0, 10, 200, 100);
        $scale = LinearScale::fromValues([-10, 20], $area);

        self::assertSame((float) $area->bottom(), $scale->y(-10));
        self::assertSame((float) $area->y, $scale->y(20));
    }

    public function test_linear_scale_ticks_with_single_tick_count_returns_minimum_value_only(): void
    {
        $scale = LinearScale::fromValues([10, 20], new PlotArea(0, 0, 200, 100));

        self::assertSame([0.0], $scale->ticks(1));
    }
    ...
    public function test_chart_types_select_expected_default_rendering_output(): void
    {
    ...
    public function test_color_validator_accepts_supported_formats_and_rejects_invalid_tokens(): void
    {
        ...
        self::assertFalse(Color::isValid('rgb(300, 99, 235)'));
        self::assertFalse(Color::isValid('rgba(37, 99, 235, 1.5)'));
